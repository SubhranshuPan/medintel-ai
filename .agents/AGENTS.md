...
| Skill | Use for |
|---|---|
| `engineering:architecture` | ADRs — evaluate/document design decisions (repo already has 12) |
...
*Last updated: 2026-07-10. Update this file when career status, project scope, or strategy fundamentally changes.*
