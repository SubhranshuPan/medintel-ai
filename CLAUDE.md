...
- Project status: Sprint 0 (docs/architecture, 20 ADRs) is complete. Sprint 1 (backend foundation — auth, data models, API skeleton, issues #5–#10) is complete — 11/11 issues, milestone closed 2026-07-12. Sprint 2 (Patient Data Platform, epic #29) is **complete and closed** — #30–#36 all merged to `develop`, including the frontend dataset upload/list UI (#36, PR #53) and a follow-up UI polish pass (shadcn/ui + Animate UI + Aceternity UI + Lenis, ADR-020, PR #56). Sprint 3 (AI & RAG) is next, not yet scoped into issues.
